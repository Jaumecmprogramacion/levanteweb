    ...
    foreach ($rss->channel->item as $item) {
        if ($counter < 3) { // Limitar a 3 noticias más recientes
            ...
            if ($media->content) {
                ...
                $image_url = isset($item->enclosure) ? $item->enclosure['url'] : ''; // Última opción, si no se encuentra la imagen en media
            }
            ...
            if (!empty($image_url)) {
                ...
                // Si no hay imagen, mostrar una imagen de respaldo (opcional)
