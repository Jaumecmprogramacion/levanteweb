...
(function(html) {
   ...
   const ssSwiper = function() {
    const etiquetas = ["Inicio", "Clasificación", "Estadística", "Próximo", "Resultados"];
    ...
    const mySwiper = new Swiper('.swiper-container', {
        ...
        pagination: {
            ...
            renderBullet: function (index, className) {
                return '<span class="' + className + '">' + etiquetas[index] + '</span>';
            }
        },
        navigation: { // Agregamos navegación pero la ocultamos por defecto
        ...
        breakpoints: {
            768: {
                slidesPerView: 1,
                navigation: false // Desactivamos las flechas en pantallas grandes
            }
        }
    });
};

// Ejecutar Swiper cuando el DOM esté listo
